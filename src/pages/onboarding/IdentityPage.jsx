  ...
  return (
    <OnboardingLayout>
      ...
      <div className="mt-6 mb-5">
        <h1 className="text-white font-bold text-xl">Identity</h1>
        <p className="text-slate-300 text-sm mt-1">Help us find the right matches for you</p>
      </div>
