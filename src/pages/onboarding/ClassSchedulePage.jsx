  ...
  return (
    <OnboardingLayout>
      ...
      <div className="mt-6 mb-5">
        <h1 className="text-white font-bold text-xl">Your Classes</h1>
        <p className="text-slate-300 text-sm mt-1">Add your current courses to find classmates</p>
      </div>
      <div className="space-y-4">
        ...
        {classes.length === 0 ? (
          <div className="border border-dashed border-slate-700 rounded-xl p-8 text-center">
            ...
            <p className="text-slate-300 text-sm">Search above to add your courses</p>
          </div>
        ) : (
            ...
            {classes.map((c) => (
              ...
              >
                ...
                <button
                  ...
                  className="text-slate-300 hover:text-red-300 transition-colors ml-3 p-1.5 -m-1.5 rounded-md"
                >
                  <svg
                    viewBox="0 0 24 24"
                    fill="none"
