 ...
 * @param {object} userB 
 */
function isMutuallyCompatible(userA, userB) {
 ...
 * @param {object[]} users 
 */
function runWeeklyMatching(users) {
  ...
  for (const pair of pairs) {
    ...
    const finalPercentage = Math.round((pair.score / MAX_POSSIBLE_SCORE) * 100);
